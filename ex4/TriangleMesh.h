...
public:
  ...
  vector<Vec3f> const & getVertices() const { return vertices; }
  vector<Vec3ui>& getTriangles() { return triangles; }
  vector<Vec3ui> const & getTriangles() const { return triangles; }
  vector<Vec3f>& getNormals() { return normals; }
  vector<Vec3f> const & getNormals() const { return normals; }
...
public:
  ...
  void rotX(float factor);
  void rotY(float factor);
  void rotZ(float factor);
  void translate(Vec3f const & translationVec);
