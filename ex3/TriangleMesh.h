...
private:
  ...
  std::optional<GLuint> maybeTextureId;
...
public:
  ...
  TriangleMesh();
  TriangleMesh(Vec3f ** rhs);
  TriangleMesh(TriangleMesh const & rhs);
  ~TriangleMesh();
  ...
  Vec3f getBoundingBoxMin() const { return boundingBoxMin; }
  Vec3f getBoundingBoxMax() const { return boundingBoxMax; }
  Vec3f getBoundingBoxMid() const { return boundingBoxMid; }
  Vec3f getBoundingBoxSize() const { return boundingBoxSize; }
...
public:
  ...
  void setWithColorArray(bool enable);
