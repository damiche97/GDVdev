...
// Set the content to be rendered here

Task task {
  //TaskType::DOLPHIN_LSA                   // uncomment to render dolphin from LSA file
  //TaskType::DOLPHIN_LSA_ANGLE_NORMALS     // uncomment to render dolphin from LSA file with angle normals
  //TaskType::DOLPHIN_OFF_ANGLE_NORMALS     // uncomment to render dolphin from OFF file with angle normals
  //TaskType::DOLPHIN_OFF                   // uncomment to render dolphin from OFF file
  //TaskType::FORD_LSA                      // uncomment to render ford from LSA file
  //TaskType::FORD_LSA_ANGLE_NORMALS        // uncomment to render ford from LSA file with angle normals
  //TaskType::FORD_OFF_ANGLE_NORMALS        // uncomment to render ford from OFF file with angle normals
  TaskType::FORD_OFF                      // uncomment to render ford from OFF file
  //TaskType::TRIANGLE_GEN                  // uncomment to generate random triangles
  , 10000                                   // number/3 of triangles to automatically generate for TRIANGLE_GEN
    
    // noticable stuttering for 3000000 triangles on Surface Pro 2 / Intel Haswell-ULT
};
...
int main(int argc, char** argv) {
  ...
  // Load mesh depending on task type selected above main()
  task.load();
    
    // Manual method:
    // Uncomment this, if you want to load LSA
    //char* filename = "Modelle/delphin.lsa";
    //char* filename1 = "Modelle/83ford-gt90.lsa";
    //trimesh.loadLSA(filename);
    //trimesh1.loadLSA(filename1);

    // Uncomment this, if you want to load OFF
    //char* filename = "Modelle/83ford-gt90.off";
    //trimesh.loadOFF(filename);

    // Uncomment to randomly generate mesh
    //triangleScene(trimesh, 10000);
...
void renderScene() {
  ...
  // Draw triangle mesh, depending on the task selected above the main() function
  task.draw();
